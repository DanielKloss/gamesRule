<script>
    ...
    let teams = [
        ...
        {name: "Blue Team", colour: "#98C5CB", score: 0},
        {name: "Yellow Team", colour: "#DDBD6A", score: 0}
    ];
    ...
    $: teamsSelected = players.find(p => p.team.name == "Blue Team") != undefined && players.find(p => p.team.name == "Yellow Team") != undefined;

    async function submitScores(){
        let session = { date: new Date().toJSON().slice(0, 10).toString(), gameId: 12};
